...
Let’s say the record was 8 wins (it’s not — but imagine it was). I’d like to know which rider covered the most kilometres *across their winning editions*. That’s our challenge.
...
You’ll notice unusual characters in the `Distance` and `Dates` columns. We’ve seen this [before](https://datasharpacademy.com/tour-de-france-meets-data-science-manipulating-strings/). It’s time to standardise data again.
...
In the next blog post series, we will continue to use sports data but combine it with the video game universe. ⚽️ x 💧🔥🌱
